...
import 'fashion.dart';
import 'top_offers_pages/women_wears.dart';
class electronic extends StatefulWidget {

  final String title;
  electronic({Key key, this.title}) : super(key: key);
  @override
...
Future<List<Offers>> loadOffers() async {
  var jsonString = await rootBundle.loadString('assets/json/electronic.json');
