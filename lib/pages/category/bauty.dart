...
class bauty extends StatefulWidget {

  final String title;

  bauty({Key key, this.title}) : super(key: key);
  @override
  State<bauty> createState() => _bautyState();
}

class _bautyState extends State<bauty> {
  bool progress = true;
...
Future<List<Offers>> loadOffers() async {
  var jsonString = await rootBundle.loadString('assets/json/bauty.json');
